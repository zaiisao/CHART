...
def evaluate(model, logmel, songs, device, fps: float = 86.1328125,
    ...
    model.eval()
    accum = {"beat_phase": [], "downbeat_phase": [], "decoder": [],
             "downbeat_emit": [], "metronome": []}
    per_song = []
    for key, audio, beats, downbeats, _meta in songs:
        ...
        db_emit = out["downbeat_prob"][0, :T].cpu().numpy()
        ...
        row = {
            ...
            "downbeat_emit": f_measure(dref, beats_from_activation(db_emit, fps, min_dist_sec=0.30)),
