...
from elbo_ab2 import elbo_ab, free_run_ab, particle_filter
import common as C
...
def main():
    ...
    ap.add_argument("--max_phase_corr", type=float, default=0.90)
    ...
    outdir = f"/home/sogang/jaehoon/VBPM_reintegration/vbpm_fix/ab/runs2/{tag}"
